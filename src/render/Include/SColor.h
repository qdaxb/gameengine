/********************************************************************
	...
	filename: 	e:\dev\C++\Projects\cardgame\branches\axb\MyCGE\MyCGE\SColor.h
	file path:	e:\dev\C++\Projects\cardgame\branches\axb\MyCGE\MyCGE
	file base:	SColor
	file ext:	h
	author:		axb
...
namespace render
{
	...
	inline us16 RGBA16(us32 r, us32 g, us32 b, us32 a=0xFF)
	{
		return (us16)((a & 0x80) << 8 |
			(r & 0xF8) << 7 |
			(g & 0xF8) << 2 |
			(b & 0xF8) >> 3);
	}
	...
	//! Creates a 16 bit A1R5G5B5 color
	inline us16 RGB16(us32 r, us32 g, us32 b)
	{
		return RGBA16(r,g,b);
	}
	...
	inline us16 RGB16from16(us16 r, us16 g, us16 b)
	{
		return (0x8000 |
				(r & 0x1F) << 10 |
				(g & 0x1F) << 5  |
	...
	inline us16 X8R8G8B8toA1R5G5B5(us32 color)
	{
		return (us16)(0x8000 |
			( color & 0x00F80000) >> 9 |
			( color & 0x0000F800) >> 6 |
	...
	inline us16 A8R8G8B8toA1R5G5B5(us32 color)
	{
		return (us16)(( color & 0x80000000) >> 16|
			( color & 0x00F80000) >> 9 |
			( color & 0x0000F800) >> 6 |
			( color & 0x000000F8) >> 3);
	}
	...
	inline us16 A8R8G8B8toR5G6B5(us32 color)
	{
		return (us16)(( color & 0x00F80000) >> 8 |
			( color & 0x0000FC00) >> 5 |
			( color & 0x000000F8) >> 3);
	}
	...
	inline us32 A1R5G5B5toA8R8G8B8(us16 color)
	{
	...
	inline us32 R5G6B5toA8R8G8B8(us16 color)
	{
		return 0xFF000000 |
			((color & 0xF800) << 8)|
			((color & 0x07E0) << 5)|
	...
	inline us16 R5G6B5toA1R5G5B5(us16 color)
	{
	...
	inline us16 A1R5G5B5toR5G6B5(us16 color)
	{
	...
	inline us32 getAlpha(us16 color)
	{
		return ((color >> 15)&0x1);
	}
	...
	/** Shift left by 3 to get 8 bit value. */
	inline us32 getGreen(us16 color)
	{
		return ((color >> 5)&0x1F);
	}
	...
	/** Shift left by 3 to get 8 bit value. */
	inline us32 getBlue(us16 color)
	{
		return (color & 0x1F);
	}
	...
	stored in a single us32. So all four values may be between 0 and 255.
	...
	This class must consist of only one us32 and must not use virtual functions.
	*/
	class SColor
	{
	public:
		...
		SColor (us32 a, us32 r, us32 g, us32 b)
		...
		void setAlpha(us32 a) { color = ((a & 0xff)<<24) | (color & 0x00ffffff); }

		//! Sets the red component of the Color.
		/** \param r: Has to be a value between 0 and 255.
		0 means no red, 255 means full red. */
		void setRed(us32 r) { color = ((r & 0xff)<<16) | (color & 0xff00ffff); }

		//! Sets the green component of the Color.
		/** \param g: Has to be a value between 0 and 255.
		0 means no green, 255 means full green. */
		void setGreen(us32 g) { color = ((g & 0xff)<<8) | (color & 0xffff00ff); }

		//! Sets the blue component of the Color.
		/** \param b: Has to be a value between 0 and 255.
		0 means no blue, 255 means full blue. */
		void setBlue(us32 b) { color = (b & 0xff) | (color & 0xffffff00); }

		//! Calculates a 16 bit A1R5G5B5 value of this color.
		/** \return 16 bit A1R5G5B5 value of this color. */
		us16 toA1R5G5B5() const { return A8R8G8B8toA1R5G5B5(color); }
		...
		void set(us32 a, us32 r, us32 g, us32 b)
		{
			color = (((a & 0xff)<<24) | ((r & 0xff)<<16) | ((g & 0xff)<<8) | (b & 0xff));
		}
		void set(us32 col) { color = col; }
		...
		SColor getInterpolated(const SColor &other, f32 d) const
		{
			...
			return SColor((us32)core::round32(other.getAlpha()*inv + getAlpha()*d),
				(us32)core::round32(other.getRed()*inv + getRed()*d),
				(us32)core::round32(other.getGreen()*inv + getGreen()*d),
				(us32)core::round32(other.getBlue()*inv + getBlue()*d));
		}
	...
	*/
	...
	public:
		...
		{
			return SColor((us32)core::round32(a*255.0f), (us32)core::round32(r*255.0f), (us32)core::round32(g*255.0f), (us32)core::round32(b*255.0f));
		}
	...
	*/
	...
	private:
		inline us32 toRGB1(f32 rm1, f32 rm2, f32 rh) const;

	};

	inline void SColorHSL::fromRGB(const SColor &color)
	{
		const us32 maxValInt = core::max_(color.getRed(), color.getGreen(), color.getBlue());
	...
	inline us32 SColorHSL::toRGB1(f32 rm1, f32 rm2, f32 rh) const
	{
		...
		return (us32) core::round32(rm1 * 255.f);
	}
