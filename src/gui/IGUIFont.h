...
namespace mycge
{
    namespace gui
    {
        ...
        public:
            ...
            virtual void Draw( const wstring& strText, const Rect<int>& rcPosition,
                D3DCOLOR color, bool bHcenter = false, bool bVcenter = false,
                const Rect<int>* rcClip = NULL ) = 0;
            ...
            virtual int GetCharacterFromPos( const wchar_t* wcsText, int nPixel_x ) const = 0;

            //! Returns the type of this font
            virtual EGUI_FONT_TYPE GetType() const { return EGFT_CUSTOM; }

            //! Sets global kerning width for the font.
            virtual void SetKerningWidth ( int nKerning ) = 0;

            //! Sets global kerning height for the font.
            virtual void SetKerningHeight ( int nKerning ) = 0;
            ...
            */
            virtual int GetKerningWidth( const wchar_t* wcsThisLetter=0, const wchar_t* wcsPreviousLetter = NULL ) const = 0;
            ...
            */
            virtual void SetInvisibleCharacters( const wchar_t *str ) = 0;
        };
    }
}