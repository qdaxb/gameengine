...
namespace mycge
{
    namespace gui
    {
        ...
        */
        ...
        const char* const GUISkinTypeNames[EGST_COUNT+1] =
        {
            "windowsClassic",
            "windowsMetallic",
            "burning",
        ...
        const char* const GUISkinColorNames[EGDC_COUNT+1] =
        {
            "3DDarkShadow",
            "3DShadow",
            "3DFace",
        ...
        const char* const GUISkinSizeNames[EGDS_COUNT+1] =
        {
            "ScrollBarSize",
            "MenuHeight",
            "WindowButtonWidth",
        ...
        //! Names for default skin sizes
        const char* const GUISkinTextNames[EGDT_COUNT+1] =
        {
            "MessageBoxOkay",
            "MessageBoxCancel",
            "MessageBoxYes",
        ...
        const char* const GUISkinIconNames[EGDI_COUNT+1] =
        {
            "windowMaximize",
            "windowRestore",
            "windowClose",
        ...
        const char* const GUISkinFontNames[EGDF_COUNT+1] =
        {
            "defaultFont",
            "buttonFont",
            "windowFont",
        ...
        public:
            ...
            virtual D3DCOLOR GetColor( EGUI_DEFAULT_COLOR color ) const = 0;

            //! Sets a default color
            virtual void SetColor( EGUI_DEFAULT_COLOR which, D3DCOLOR newColor ) = 0;

            //! returns size for the given size type
            virtual int GetSize( EGUI_DEFAULT_SIZE size ) const = 0;
...
//             virtual void SetSpriteBank(IGUISpriteBank* bank) = 0;
            ...
            virtual unsigned int GetIcon( EGUI_DEFAULT_ICON icon ) const = 0;
            ...
            virtual void SetIcon( EGUI_DEFAULT_ICON icon, unsigned int index ) = 0;
            ...
            virtual void Draw3DSunkenPane( IGUIElement* element,
                D3DCOLOR bgcolor, bool flat, bool fillBackGround,
                const Rect<int>& rect,
                const Rect<int>* clip = 0 ) = 0;
            ...
            virtual Rect<int> Draw3DWindowBackground( IGUIElement* element,
                bool drawTitleBar, D3DCOLOR titleBarColor,
                const Rect<int>& rect,
                const Rect<int>* clip = 0,
                Rect<int>* checkClientArea = 0 ) = 0;
            ...
            virtual void Draw3DTabButton( IGUIElement* element, bool active,
                const Rect<int>& rect, const Rect<int>* clip = 0, EGUI_ALIGNMENT alignment = EGUIA_UPPERLEFT ) = 0;
            ...
            virtual void Draw3DTabBody( IGUIElement* element, bool border, bool background,
                const Rect<int>& rect, const Rect<int>* clip = 0, int tabHeight = -1, gui::EGUI_ALIGNMENT alignment = EGUIA_UPPERLEFT ) = 0;
            ...
            virtual void DrawIcon( IGUIElement* element, EGUI_DEFAULT_ICON icon,
                const Position2DInt position, unsigned int starttime = 0, unsigned int currenttime = 0,
                bool loop = false, const Rect<int>* clip = 0 ) = 0;
            ...
            virtual void Draw2DRectangle( IGUIElement* element, const D3DCOLOR &color,
                const Rect<int>& pos, const Rect<int>* clip = 0) = 0;
